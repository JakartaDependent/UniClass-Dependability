package it.unisa.uniclass.Analysis;
    ...
    public static void main(String[] args) {
        ...
        inputLocations.add(
                new JavaClassPathAnalysisInputLocation(
                        "C:\\Users\\lucag\\IdeaProjects\\UniClass-Dependability\\target\\classes"));
        inputLocations.add(
                new JavaClassPathAnalysisInputLocation(
                        System.getProperty("java.home") + "/lib/rt.jar")); // add rt.jar (opzionale su Java 21)
